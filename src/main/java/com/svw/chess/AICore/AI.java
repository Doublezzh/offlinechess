...
import static com.svw.chess.HomeActivity.zobrist;
import static com.svw.chess.PvMActivity.transformTable;
...
public class AI {
    ...
    public static Move getBestMove(int[][] piece, boolean isRedGo, int depth, int startZobristKey, long startZobristKeyCheck, Map<Long, Integer> ZobristInfo) {
        ...
        //LogUtils.i("博弈树搜索算法比对","搜索结点数："+String.valueOf(searchCnt));
        return bestMove;
    }
